...
_CITIES = {
    ...
    # Kansas
    'kansas city':(39.0997,-94.5786),'wichita':(37.6872,-97.3301),
    'overland park':(38.9822,-94.6708),'topeka':(39.0558,-95.6890),
    'olathe':(38.8814,-94.8191),'lawrence':(38.9717,-95.2353),
    'manhattan':(39.1836,-96.5717),'salina':(38.8403,-97.6114),
    'hutchinson':(38.0608,-97.9298),'lenexa':(38.9536,-94.7336),
    'shawnee':(39.0228,-94.7155),'kansas':(38.5266,-96.7265),
    # UK
